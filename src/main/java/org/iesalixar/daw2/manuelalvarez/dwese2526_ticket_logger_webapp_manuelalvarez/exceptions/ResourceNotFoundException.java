...
public class ResourceNotFoundException extends RuntimeException {
    ...
    /**
     * Excepción genérica que indica que no se ha encontrado un recurso en la aplicación. * Se utiliza típicamente en la capa de servicios cuando, tras consultar el repositorio, * no existe una entidad con el valor buscado (por ejemplo, una región con id=5).
     public class ResourceNotFoundException extends RuntimeException {
     /**
